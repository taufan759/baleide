...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Manajemen Kategori Artikel</h1>
        </div>
...
$(document).ready(function() {
    ...
    function loadData() {
        $.get('{{ url("admin/manage-master/artikel-kategori/all") }}', function(response) {
            let html = '';
            ...
            $('#tableCategory tbody').html(html);
        });
    }

    $('#formTambah').on('submit', function(e) {
        e.preventDefault();
        $.post('{{ url("admin/manage-master/artikel-kategori") }}', $(this).serialize(), function(response) {
    ...
    $('body').on('click', '.edit', function() {
        let id = $(this).data('id');
        $.post('{{ url("admin/manage-master/artikel-kategori/get") }}', {
            _token: '{{ csrf_token() }}',
            id: id
        }, function(data) {
            $('#edit_id').val(data.id);
    ...
    $('#formEdit').on('submit', function(e) {
        e.preventDefault();
        $.post('{{ url("admin/manage-master/artikel-kategori/update") }}', $(this).serialize(), function(response) {
    ...
    $('body').on('click', '.hapus', function() {
        ...
        swal({
            ...
            if (willDelete) {
                $.ajax({
                    url: '{{ url("admin/manage-master/artikel-kategori") }}',
                    type: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}',
                        id: id
